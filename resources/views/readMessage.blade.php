                    ...
                    <div class="p-6 bg-white border-b border-gray-200 w-full">
                        ...
                        <div class="flex flex-col justify-center items-center bg-gray-100 mt-11">
                            ...
                            <form action="#" class="w-full">                       
                              ...
                              <div class="p-3">
                                <textarea class="resize-none border rounded-md block appearance-none placeholder-gray-500 placeholder-opacity-100 border border-light-blue-400 rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:ring-2 focus:ring-light-blue-300 h-56" placeholder="Reply message" required></textarea>
                              </div>
                              <div class="p-3 pt-4">
